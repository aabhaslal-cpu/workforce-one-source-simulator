...
| Gmail        | `gmail.ts`        | Message and Thread resources, headers, labelIds, late email, and trash-as-update representation                     |
...
| GitHub       | `github.ts`       | REST issue, pull request, commit, and release resources with users, reviewers, refs, and last-known delete payloads |
