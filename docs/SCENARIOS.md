...
Account-bearing instances are distributed deterministically across ten fictional customers: Northstar Medical, Summit Foods, Cobalt Bank, Beacon Retail, Atlas Logistics, Pioneer Health, BluePeak Energy, Redwood Manufacturing, Juniper Education, and Solstice Media. Applicable source bodies and account permission groups use the selected instance's customer context. Northstar is one customer in the portfolio, not the default customer for every scenario.
